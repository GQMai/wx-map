...
Page({
  data: { // 默认数据
    latitude: 22.5529, // 地图中心纬度
    longitude: 114.0893, // 地图中心经度
    location: '', // 经纬度输入框
    address: '', // 地址输入框
  ...
  markerTap: function (e) {
    let school = constants.SCHOOLS[e.markerId]
    this.setData({
      info: {
        name: school.name,
        class: school.class,
  ...
  onLoad() {
    ...
    var markers = constants.SCHOOLS.map(function (item, index) {
      ...
      return {
        ...
        title: item.name,
        iconPath: getIconPathBySchoolType(item.type),
        //<a target="_blank" href="https://icons8.com/icon/iAjopNFQNw6O/school-location">School Location</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a>
        width: '40',
        height: '40',
        callout: {
          display: 'ALWAYS',
...
function getIconPathBySchoolType(schoolTYpe) {
  let iconPath = ""
  switch (schoolTYpe) {
    case '市属公办园':
      iconPath = "../../asset/inclusive-school.png";
      break;
    case '区属公办园':
      iconPath = "../../asset/public-school.png";
      break;
    case '民办普惠园':
      iconPath = "../../asset/inclusive-school.png";
      break;
    case '民办非普惠园':
      iconPath = "../../asset/private-school.png";
      break;
    default:
      iconPath = "../../asset/rebuildng-school.png";
  }
  return iconPath;
}